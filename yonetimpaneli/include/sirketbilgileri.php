...
if(isset($_GET['sil']))
{
    $sqlsi="DELETE FROM sirketbilgileri WHERE id=$kayit_id";
...
$sorgu = $baglanti->query("SELECT * FROM sirketbilgileri"); // Makale tablosundaki tüm verileri çekiyoruz.

while ($sonuc = $sorgu->fetch_assoc()) { 

$id = $sonuc['id']; // Veritabanından çektiğimiz id satırını $id olarak tanımlıyoruz.
$lisansno = $sonuc['lisansno'];
$sirketkodu = $sonuc['sirketkodu'];
$sirketadi = $sonuc['sirketadi'];
$islem_tarihi = $sonuc['islem_tarihi'];
...
?>
    ...
    <tr>
        ...
        <td><?php echo $lisansno; ?></td>
        <td><?php echo $sirketkodu; ?></td>
        <td><?php echo $sirketadi; ?></td>
        <td><?php echo $islem_tarihi; ?></td>
        <td><a href="include/ysirketekle.php?id=<?php echo $id; ?>" class="btn btn-primary">Düzenle</a></td>
        <td><a href="include/ssil.php?id=<?php echo $id; ?>" class="btn btn-danger" name="sil">Sil</a></td>
    </tr>
