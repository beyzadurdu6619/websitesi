...
<head>
  ...
  <meta name="viewport" content="<?=SITE?>width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  ...
  <link href="<?=SITE?>https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
</head>
